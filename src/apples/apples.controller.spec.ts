...
describe('ApplesController', () => {
  ...
  describe('findAll', () => {
    it('should call applesService to findAll apples', () => {
      ...
      jest
        .spyOn(applesService, 'findAll')
        .mockImplementation(() => findAllResult);
  ...
  describe('findOne', () => {
    it('should call applesService to findOne apple', () => {
      ...
      jest
        .spyOn(applesService, 'findOne')
        .mockImplementation(() => findOneResult);
  ...
  describe('update', () => {
    it('should call applesService to update the apple', () => {
      ...
      expect(applesController.update(updateId, updateAppleDto)).toBe(
        updateResult,
      );
    });
  });
  ...
  describe('remove', () => {
    it('should call applesService to remove the apple', () => {
      ...
      jest
        .spyOn(applesService, 'remove')
        .mockImplementation(() => removeResult);
